export const applicationsDataOld = [
  {
    id: 1,
    severity: "medium",
...
export const applicationsData = [
  {
    id: 1,
    severity: "medium",
    technicalControlName: "Vivamus vestibulum ntulla nec ante",
    tickets: [{ reference: "PRB12345678", type: "problem" }],
    raisedDateTime: "2023-06-23T10:19:15.832Z",
    environment: "Production",
    resources: [
      { id: 1, name: "Server Instance 1", status: "none" },
      { id: 2, name: "Server Instance 2", status: "none" },
      { id: 3, name: "Server Instance 3", status: "none" },
    ...
    control: "AWS ECS Pattern  CPU Monitoring",
    frameworks: [
      { name: "PCI-DSS", url: "/" },
      { name: "ISO27K", url: "/" },
      { name: "GPK", url: "/" },
  ...
  },
  {
    ...
    tickets: [{ reference: "INC12345678", type: "incident" }],
    raisedDateTime: "2023-06-23T11:09:15.833Z",
    environment: "Production",
    resources: [{ id: 1, name: "Server Instance 1", status: "pending" }],
    control: "AWS ECS Pattern  CPU Monitoring",
    frameworks: [
      { name: "PCI-DSS", url: "/" },
      { name: "ISO27K", url: "/" },
  ...
  },
  {
    id: 3,
    severity: "low",
    technicalControlName: "Integer vitae libero ac risus egestas placerat",
    tickets: [
      { reference: "INC12345678-ABT", type: "incident" },
      { reference: "PRB12345678", type: "problem" },
      {
        reference:
          "RSK12345678QJDTANDKRSK12345678QJDTANDKRSK12345678QJDTANDKRS",
        type: "risk",
    ...
    raisedDateTime: "2023-06-22T11:19:15.833Z",
    environment: "UAT",
    resources: [{ id: 1, name: "Server Instance 1", status: "pending" }],
    control: "AWS ECS Pattern  CPU Monitoring",
    frameworks: [
  ...
  },
  {
    ...
    severity: "low",
    technicalControlName:
      "Vivamus id diam bibendum, rhoncus leo quis, consequat",
    tickets: [{ reference: "INC12345678-ABT", type: "incident" }],
    raisedDateTime: "2023-05-23T11:19:15.833Z",
    environment: "UAT",
    resources: [{ id: 1, name: "Server Instance 1", status: "pending" }],
    control: "AWS ECS Pattern CPU Monitoring",
    frameworks: [
  ...
  },
  {
    id: 5,
    severity: "medium",
    technicalControlName: "Phasellus fermentum tincidunt nisl",
    // tickets: [{ reference: "PRB12345678", type: "problem" }],
    tickets: [],
    raisedDateTime: "2022-06-23T11:19:15.833Z",
    environment: "UAT",
    resources: [{ id: 1, name: "Server Instance 1", status: "pending" }],
    control: "AWS ECS Pattern  CPU Monitoring",
    frameworks: [
