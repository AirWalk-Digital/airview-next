  ...
  useEffect(() => {
    ...
    const filterRowsWithNoJobsAndLessHolidays = (users, displayedMonths) => {
      return users.filter((user) => {
        ...
        const hasNoJobsInDisplayedMonths = displayedMonths.some(
        ...
        const hasLessDaysAllocated = user.jobs.some((job) => {
          const isInDisplayedMonths = displayedMonths.some((displayedMonth) =>
        ...
        <FormGroup row>
          ...
          <FormControlLabel
            control={
              ...
              checked={filters["Red"]}
                onChange={(e) =>
                  handleFilterChange("Red", e.target.checked)
                }
              />
            }
          ...
          <FormControlLabel
            control={
              ...
              checked={filters["MH"]}
                onChange={(e) =>
                  handleFilterChange("MH", e.target.checked)
                }
              />
            }
            label="Mansion House"
